...
@Component({
    selector: 'governance-metadata-aside-component',
    templateUrl: './governance.metadata.aside.component.html',
    styleUrls: ['./governance.metadata.aside.component.scss']
})

export class GovernanceMetadataAsideComponent implements  OnInit, OnDestroy {
    ...
    ngOnInit() {
        this.governanceService.getCatalogList({id: 0}).then(d => {
            if (d.success) {
                ...
                // this.getAllRule(this.flows[0].id, this.flows[0]);
